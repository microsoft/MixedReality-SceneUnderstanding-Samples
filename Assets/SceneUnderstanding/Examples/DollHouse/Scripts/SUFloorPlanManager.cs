...
public class SUFloorPlanManager : MonoBehaviour
{
    ...
    void ToggleSceneRootVisibility()
    {
    ...
    //The minimap is the miniature SU representation
    ...
    private void BoudingBoxOn()
    {
        ...
        else
        {
            ...
            //Create the Scene Objects Ids for the vertex shader, encode it like UV coordinates
            List<Vector2> WallIds = new List<Vector2>()
            {
            ...
            List<Vector2> FloorIds = new List<Vector2>()
            {
            ...
            List<Vector2> CeilingIds = new List<Vector2>()
            {
            ...
            gbjFrontWall.GetComponent<MeshFilter>().mesh.SetUVs(2, WallIds);
            ...
            gbjLeftWall.GetComponent<MeshFilter>().mesh.SetUVs(2, WallIds);
            ...
            gbjRightWall.GetComponent<MeshFilter>().mesh.SetUVs(2, WallIds);
            ...
            gbjBackWall.GetComponent<MeshFilter>().mesh.SetUVs(2, WallIds);
            ...
            gbjFloorWall.GetComponent<MeshFilter>().mesh.SetUVs(2, FloorIds);
            ...
            gbjCeilingWall.GetComponent<MeshFilter>().mesh.SetUVs(2, CeilingIds);
